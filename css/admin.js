(function () {
    ...
    function installEvents(){
        ...
        $('#approvalStatus').addEventListener('change',loadApprovals);$('#approvalReviewForm').addEventListener('submit',submitApprovalReview);$('#supplementEvidenceRefresh').addEventListener('click',loadSupplementalEvidence);$('#supplementEvidenceForm').addEventListener('submit',submitSupplementEvidence);
