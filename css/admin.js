(function () {
    ...
    const pageTitles = { overview: 'Tổng quan', products: 'Sản phẩm', orders: 'Đơn hàng', users: 'Người dùng', content: 'Tin tức & Hướng dẫn', support: 'Hỗ trợ khách hàng', notifications: 'Thông báo khách hàng', vouchers: 'Voucher', deposits: 'Yêu cầu nạp tiền', approvals: 'Phê duyệt thay đổi', audit: 'Nhật ký quản trị' };
    const statusMeta = {
    ...
    function installEvents(){
        ...
        $('#approvalStatus').addEventListener('change',loadApprovals);$('#approvalReviewForm').addEventListener('submit',submitApprovalReview);
