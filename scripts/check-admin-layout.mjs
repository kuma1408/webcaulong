...
assert.equal(panels.length, 12, 'All 12 admin panels must remain in workspace');
...
console.log('Admin layout: balanced HTML, unique IDs, 12 panels and overview charts correctly nested.');
