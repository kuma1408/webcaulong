...
- Bán hàng: giỏ hàng, cấu hình vợt/cước/lực căng theo từng mặt hàng, kiểm tra
  tồn kho trong transaction, voucher một lần mỗi tài khoản, COD, số dư hoặc
  VietQR đơn hàng đúng số tiền/mã đối soát, hủy/hoàn tiền và lịch sử đơn.
